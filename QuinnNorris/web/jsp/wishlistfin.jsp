...
<div id="wrapper">
    ...
    top: 1px;"></i>&nbsp;&nbsp;
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2 style="padding-top: 5px;">实现心愿</h2>
            </div>
            <div class="col-lg-2">
...
<script>
    ...
    function jumppagegeb() {
        window.location.href = urldomain + '/wishlistfin';
    }

    function jumppageend() {
        var all_page = $('#all_page').val();
        window.location.href = urldomain + '/wishlistlistfin?to_page=' + all_page;
    }
    ...
    function jumppage(toPage) {
        ...
        window.location.href = urldomain + '/wishlistlistfin?to_page=' + to_page;
    }
