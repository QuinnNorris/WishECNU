    ...
    <div>
        ...
        <div class="m-t" role="form">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="手机号" id="phone" required="">
            </div>
            <div class="form-group">
                <input type="password" class="form-control" placeholder="密码" id="pw" required="">
            </div>
            <div class="form-group">
                <input type="password" class="form-control" placeholder="重复密码" id="re_pw" required="">
            </div>
            ...
            <div><span style="float: left;margin: 10px 0 15px 3px;"><small id="tip" hidden style="color: #b1b1b1;"></small></span></div>
            <div style="height: 15px;"></div>
            <button type="submit" class="btn btn-primary block full-width m-b" style="background-color: #ed5565;border-color: #ed5565;" onclick="sign_up()">注册</button>
