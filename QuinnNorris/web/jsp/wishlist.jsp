...
<div id="wrapper">
    ...
    top: 1px;"></i>&nbsp;&nbsp;
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2 style="padding-top: 5px;">心愿列表</h2>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <c:if test="${wishs_size != 0}">
                    <c:forEach items="${wishs}" var="item">
                        <div class="col-lg-3">
                            <div class="ibox float-e-margins" onclick="to_one_wish(${item.wish_id})">
                                <div class="ibox-title">
                                    <span class="label <%--label-info--%>${item.sexsclass}  pull-right"><i
...
<script>
    ...
    function jumppageend() {
        ...
        window.location.href = urldomain + '/wishlistlist?to_page=' + all_page;
    }
    ...
    function jumppage(toPage) {
        ...
        window.location.href = urldomain + '/wishlistlist?to_page=' + to_page;
    }

    function to_one_wish(wishid) {
        window.location.href = urldomain + '/wish?wishid=' + wishid;
    }
</script>
</html>
